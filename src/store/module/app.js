...
export default {
  ...
  getters: {
    menuList: (state, getters, rootState) => {
      console.log(' %c 🐱‍🏍 app.js->router: ', 'font-size:20px;background-color: #42b983;color:#fff;', router)
      // return  getMenuByRouter(routers.concat(community), rootState.user.access)
      return  getMenuByRouter(routers.concat(rootState.user.routes), rootState.user.access)
      // return  getMenuByRouter(routers.concat(rootState.user.routes), rootState.user.access)
